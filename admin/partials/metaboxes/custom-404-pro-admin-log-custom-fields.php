...
<table class="form-table">
	<tbody>
		<tr>
			<td>IP</td>
			<td>
				<input type="text" name="c4p_log_ip" value="<?php echo $c4p_log_ip; ?>" placeholder="User IP Address" class="widefat" disabled />
			</td>
		</tr>
		<tr>
			<td>404 Path</td>
		...
		<tr>
			<td>Redirect</td>
			<td>
				<input type="text" name="c4p_log_redirect_to" value="<?php echo $c4p_log_redirect_to; ?>" placeholder="Where does this 404 redirect to?" class="widefat"  />
			</td>
		</tr>
	</tbody>
</table>
