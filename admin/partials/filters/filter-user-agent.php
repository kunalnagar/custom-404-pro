<select name="ua_browser_names">
	...
	<option value="<?php echo $field['meta_value']; ?>" <?php if($_GET['ua_browser_names'] === $field['meta_value']) echo 'selected'; ?>>
...
<select name="ua_browser_versions">
	...
	<?php foreach($agent_version_fields as $field): ?>
		<option value="<?php echo $field['meta_value']; ?>" <?php if($_GET['ua_browser_versions'] === $field['meta_value']) echo 'selected'; ?>>
			<?php echo $field['meta_value']; ?>
		</option>
	<?php endforeach; ?>
</select>
<select name="ua_os_types">
	...
	<?php foreach($os_type_fields as $field): ?>
		<option value="<?php echo $field['meta_value']; ?>" <?php if($_GET['ua_os_types'] === $field['meta_value']) echo 'selected'; ?>>
			<?php echo $field['meta_value']; ?>
		</option>
	<?php endforeach; ?>
</select>
