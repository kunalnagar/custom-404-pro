...
<div class="wrap">
    ...
    <a href="?page=c4p-main&tab=settings-global-redirect" class="nav-tab <?php echo $active_tab === 'settings-global-redirect' ? 'nav-tab-active': '' ?>">
    Global Redirect
    </a>
    <a href="?page=c4p-main&tab=settings-general" class="nav-tab <?php echo $active_tab === 'settings-general' ? 'nav-tab-active': '' ?>">
    General
    </a>
    </h2>
</div>
